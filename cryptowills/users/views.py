...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user = User.objects.create_user( country=country,
                                             email=email,
                                             username=username
                                             )
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user:
                ...
                messages.Error(request, 'This email or password does not exist, Please try again')
        else:
...
def add_benefactor(request):
    ...
    if request.method =='POST':
        if form.is_valid:
            ...
            beneficiary = Beneficiary.objects.create(user=request.user,
