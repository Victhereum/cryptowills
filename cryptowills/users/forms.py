...
class AddBeneficiary(forms.ModelForm):
    ...
    class Meta:
        model = Beneficiary
        fields = ['coin_ticker','wallet_address', 'identifier',]

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['wallet_address'].widget.attrs['placeholder'] = 'a wallet address'
        self.fields['identifier'].widget.attrs['placeholder'] = 'A name tag for this account'
        self.fields['coin_ticker'].widget.attrs['placeholder'] = 'Ticker e.g. BTC, USDT, BNB'
